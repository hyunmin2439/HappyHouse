...
- 별점이 4점이상이고 상태가 판매중 또는 취소됨 매물 4가지를 랜덤하게 추천
...
## 매물 검색
- 매물 검색 시 등록된 해당 매물 사진을 표시

- 평균시세, 평균평수, 건축년도, 별점, 상태 정보를 표시
...
## 매물 검색
- 위치와 추가 조건에 따른 부동산 매물 검색 및 정렬 기능을 제공

- 검색 시 해당 부동산 매물의 위치를 지도에 표시
...
## 상세 정보
- 지도에 표시된 부동산 매물, 상가 아이콘을 클릭시 상세한 정보 표시
